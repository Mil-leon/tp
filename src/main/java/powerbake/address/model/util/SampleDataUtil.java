...
public class SampleDataUtil {
    ...
    public static final Pastry PASTRY_1 = new Pastry(new powerbake.address.model.pastry.Name("Apple Pie"), new Price("3.50"));
    public static final Pastry PASTRY_2 = new Pastry(new powerbake.address.model.pastry.Name("Brownie"), new Price("2.50"));
    public static final Pastry PASTRY_3 = new Pastry(new powerbake.address.model.pastry.Name("Cheesecake"), new Price("4.00"));
